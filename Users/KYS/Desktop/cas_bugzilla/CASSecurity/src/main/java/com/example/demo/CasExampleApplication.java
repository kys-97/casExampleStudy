...
public class CasExampleApplication {

	private static final Logger logger = LoggerFactory.getLogger(CasExampleApplication.class);

    public static void main(String... args) {
        SpringApplication.run(CasExampleApplication.class, args);
    }
